...
#include "gtkobjects/unibenchmark-window.h"
...
on_activate(GtkApplication *app) {
	...
	gtk_css_provider_load_from_resource(provider, "/org/gnome/unibenchmark/style.css");
...
main(int argc, char *argv[]) {
	 ...
	 */
	app = gtk_application_new("org.gnome.unibenchmark", G_APPLICATION_DEFAULT_FLAGS);
